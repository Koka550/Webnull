...
function changeBGImg(){
    ...
    if(defColorMode == 'standard'||defColorMode == 'random'){
        document.documentElement.style.setProperty('--title-color', '#8B4513');
        document.documentElement.style.setProperty('--bg-url', 'url("https://images.pexels.com/photos/172277/pexels-photo-172277.jpeg?cs=srgb&dl=abstract-antique-background-board-172277.jpg&fm=jpg")');
    }
    else if(defColorMode == 'dark'){
        document.documentElement.style.setProperty('--title-color', '#448285');
        document.documentElement.style.setProperty('--bg-url', 'url("https://images.pexels.com/photos/745365/pexels-photo-745365.jpeg?cs=srgb&dl=analog-clock-sketch-in-black-surface-745365.jpg&fm=jpg")');
    }
    else if(defColorMode == 'rainbow'){
        document.documentElement.style.setProperty('--title-color', '#f6fa00');
        document.documentElement.style.setProperty('--bg-url', 'url("https://images.pexels.com/photos/1191710/pexels-photo-1191710.jpeg?cs=srgb&dl=assorted-color-sequins-1191710.jpg&fm=jpg")');
    }
